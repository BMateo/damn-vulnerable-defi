...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    ...
    /**
     * It is possible to earn the most of the rewards by depositing an amount close to the 100% of tokens deposited
     * i think the problem here is how the rewards are calculated or the way the current snapshot and the total deposited are updated
     */
    ...
    await rewarderAttacker.deployed();
